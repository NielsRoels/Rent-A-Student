...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'imd_myfosuser.imdregistration.form.type' => 'getImdMyfosuser_Imdregistration_Form_TypeService',
            'imd_myfosuser.profile.edit.type' => 'getImdMyfosuser_Profile_Edit_TypeService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'RentAStudent', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array('enum' => 'string'));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Imd/AppBundle/Entity'))), 'Imd\\AppBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('ImdAppBundle' => 'Imd\\AppBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_feced56fda51f4c45fe014f38033ede571b0213f80fc9c9a02dd2d9035506ea1');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Imd\\AppBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'imd_myfosuser_profile_edit', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Imd\\AppBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Imd\\AppBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Imd\\AppBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Imd\\AppBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.facebook'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\FacebookResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => 804288792993299, 'client_secret' => '7baf03cc0c0a8d8ab3ec23a9212b2cbe', 'scope' => 'public_profile, email, user_birthday, user_about_me, user_hometown, user_website', 'infos_url' => 'https://graph.facebook.com/me?fields=id,about,address,bio,birthday,email,first_name,gender,hometown,last_name,website,picture.type(square).width(800).height(800)', 'paths' => array('email' => 'email', 'profilepicture' => 'picture.data.url'), 'options' => array()), 'facebook', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.github'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\GitHubResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '217d968ea949ab7b0880', 'client_secret' => '3b52f77e5d515144e368e97ece0d567fff696b32', 'scope' => 'user:email', 'options' => array('csrf' => true), 'paths' => array('email' => 'email')), 'github', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.twitter'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\TwitterResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => 'Hh8JKiiAeywBcaVR4MLDQLyQm', 'client_secret' => '8psWNysuP9wBt8CYU7JdsKbctwnV29OgrGj3gKJXtvm1hRRafv', 'paths' => array(), 'options' => array()), 'twitter', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        $this->services['hwi_oauth.resource_ownermap.main'] = $instance = new \HWI\Bundle\OAuthBundle\Security\Http\ResourceOwnerMap($this->get('security.http_utils'), array(0 => 'facebook', 1 => 'github', 2 => 'twitter'), array('facebook' => '/login/check-facebook', 'google' => '/login/check-google', 'twitter' => '/login/check-twitter', 'github' => '/login/check-github'));
    ...
    {
        return $this->services['hwi_oauth.user.provider.fosub_bridge'] = new \HWI\Bundle\OAuthBundle\Security\Core\User\FOSUBUserProvider($this->get('fos_user.user_manager'), array('facebook' => 'facebook_id', 'google' => 'google_id', 'twitter' => 'twitter_id', 'github' => 'github_id'));
    }
    ...
    /**
     * Gets the 'imd_myfosuser.imdregistration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Imd\MyFosUserBundle\Form\Type\ImdRegistrationFormType A Imd\MyFosUserBundle\Form\Type\ImdRegistrationFormType instance.
     */
    protected function getImdMyfosuser_Imdregistration_Form_TypeService()
    {
        return $this->services['imd_myfosuser.imdregistration.form.type'] = new \Imd\MyFosUserBundle\Form\Type\ImdRegistrationFormType();
    }

    /**
     * Gets the 'imd_myfosuser.profile.edit.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Imd\MyFosUserBundle\Form\Type\ProfileFormType A Imd\MyFosUserBundle\Form\Type\ProfileFormType instance.
     */
    protected function getImdMyfosuser_Profile_Edit_TypeService()
    {
        return $this->services['imd_myfosuser.profile.edit.type'] = new \Imd\MyFosUserBundle\Form\Type\ProfileFormType('Imd\\AppBundle\\Entity\\User');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Imd\AppBundle\Security\Core\User\FOSUserProvider A Imd\AppBundle\Security\Core\User\FOSUserProvider instance.
     */
    protected function getMyUserProviderService()
    {
        return $this->services['my_user_provider'] = new \Imd\AppBundle\Security\Core\User\FOSUserProvider($this->get('fos_user.user_manager'), array('facebook' => 'facebook_id', 'google' => 'google_id', 'twitter' => 'twitter_id', 'github' => 'github_id'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('FOS\\UserBundle\\Model\\UserInterface' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 12))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $a, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($a, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        ...
        $j = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($c, $a, array(), $d);
        ...
        $k->setOptions(array('login_path' => '/login', 'default_target_path' => '/', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $k->setProviderKey('main');

        $l = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($c, $a, array(), $d);
        $l->setOptions(array('login_path' => '/login', 'failure_path' => '/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $m = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener($b, $e, $f, $a, 'main', $k, $l, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true), $d, $g);
        $m->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.main'));
        $m->setCheckPaths(array(0 => '/login/check-facebook', 1 => '/login/check-google', 2 => '/login/check-twitter', 3 => '/login/check-github'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => $this->get('security.context_listener.0'), 2 => $h, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $e, $f, $a, 'main', $i, $j, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $d, $g, $this->get('form.csrf_provider')), 4 => $m, 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '55de3c1f5c721', $d, $e), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $a, 'main', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($c, $a, '/login', false), NULL, NULL, $d));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Imd/AppBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Imd/MyFosUserBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Imd/AppBundle/Resources/views'), 'ImdApp');
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Imd/MyFosUserBundle/Resources/views'), 'ImdMyFosUser');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addYamlMappings(array(0 => ($this->targetDirs[3].'/src/Imd/AppBundle/Resources/config/validation.yml')));
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/imd/register'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/guest/login'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'admin', $c, true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55de3c1f5c721'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'main', $c, true), 3 => new \HWI\Bundle\OAuthBundle\Security\Core\Authentication\Provider\OAuthProvider($this->get('my_user_provider'), $this->get('hwi_oauth.resource_ownermap.main'), $b), 4 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55de3c1f5c721')), true);
    ...
    {
        return $this->services['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener($this->get('security.context'), array(0 => $this->get('fos_user.user_provider.username_email')), 'my_shared_firewalls', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ImdAppBundle' => 'Imd\\AppBundle\\ImdAppBundle',
                'HWIOAuthBundle' => 'HWI\\Bundle\\OAuthBundle\\HWIOAuthBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'ImdMyFosUserBundle' => 'Imd\\MyFosUserBundle\\ImdMyFosUserBundle',
            ...
            'my_user_provider.class' => 'Imd\\AppBundle\\Security\\Core\\User\\FOSUserProvider',
            ...
            'fos_user.model.user.class' => 'Imd\\AppBundle\\Entity\\User',
            'fos_user.profile.form.type' => 'imd_myfosuser_profile_edit',
